...
item1 = Item(user_id=1, title = "Eco Friendly Yoga Matt",
...
item2 = Item(user_id=1, title = "Hangzhou Biodegradable Matt",
...
item3 = Item(user_id=1, title = "Custom Jump Ropes",
...
item4 = Item(user_id=1, title = "Sweat Resistance Bands",
...
# Matcha Tea item1
item1 = Item(user_id=1, title = "100% Organic Matcha Tea",
...
# Matcha Tea item2
item2 = Item(user_id=1, title = "Green Matcha Tea",
...
# Beard oil is Item3
item3 = Item(user_id=1, title = "Organic Beard Oil",
...
# Mobile phone cases
item1 = Item(user_id=1, title = "For samsung Galaxy 10",
...
item2 = Item(user_id=1, title = "For Iphone X",
...
item3 = Item(user_id=1, title = "Solar Mobile Phone Power Bank",
...
item4 = Item(user_id=1, title = "Wireless Mobile Phone Power Bank",
...
item1 = Item(user_id=1, title = "170T Sleep Bag",
...
item2 = Item(user_id=1, title = "190T Tent",
...
item1 = Item(user_id=1, title = "Giant Pink Flamingo Pool Inflatable",
...
item2 = Item(user_id=1, title="Funtal",
...
item1 = Item(user_id=1, title = "Jersey",
...
item2 = Item(user_id=1, title = "Two Shinguards",
...
item3 = Item(user_id=1, title = "Shinguards",
...
item4 = Item(user_id=1, title = "Soccer Cleats",
...
item1 = Item(user_id=1, title="James Basketball Jersey", \
...
item2 = Item(user_id=1, title="Boys embroidery shorts", \
...
item2 = Item(user_id=1, title="Basketball", \
...
item1 = Item(user_id=1, title = "Rayodisk",
...
item2 = Item(user_id=1, title="Joylight", \
...
item1 = Item(user_id=1, title="YiQile", \
...
item2 = Item(user_id=1, title="Huari", \
...
item1 = Item(user_id=1, title="JC skating shoes", \
...
item2 = Item(user_id=1, title="PAPAISON", \
...
item2 = Item(user_id=1, title="Tiuden Sports", \
...
# Lace Bras
item1 = Item(user_id=1, title = "BEIZHI Lace Bras",
...
# Cat Eye Sun Glasses
item2 = Item(user_id=1, title = "Trendy women",
...
item3 = Item(user_id=1, title = "Retro Vintage Cateye",
